  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        <span class="d-block d-lg-none">ABOUT ME</span>
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/pr.jpg" alt="myprofileimage">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">IBADAN, ILE-IFE NIGERIA
            <a href="mailto:name@email.com">sollysamuel12@gmail.com</a>
          </div>
          ...
          <ul class="list-inline list-social-icons mb-0">
            <li class="list-inline-item">
              <a href="https://www.facebook.com/ojo.tobi.16">
            ...
            <li class="list-inline-item">
              <a href="https://www.twitter.com/TechTI90">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              ...
              <div class="subheading mb-3">Witt Technologies</div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Obafemi Awolowo University</h3>
              <div class="subheading mb-3">Bachelor of Science</div>
              <div>Management and Accounting - Web Development Track</div>
      ...
      <div style="font-size: 16px;" class="row text-warning" id="footer text-center ">
        ...
        <div class="col-md-3"> &copy; Copyright 2018. Startbootstrap</div>
		 <div class="col-md-3">Powered by <strong>Witt Technologies</strong></div>
		  ...
		  <div class="col-md-3" title="Nothing is here yet. More updates coming soon.">
		  Privacy Policy
		  </div>
		  <div class="col-md-3" title="Nothing is here yet. More updates coming soon.">
